...
public class DateUtil {
     ...
     * @return
     */
    public static String getTimeGap(@NonNull Context context, @NonNull Date date) {
        ...
        if (subTime < MILLIS_LIMIT) {
            ...
            return Math.round(subTime / MILLIS_LIMIT) + " " + "seconds ago";
        } else if (subTime < MINUTES_LIMIT) {
            return Math.round(subTime / SECONDS_LIMIT) + " " + "minutes ago";
        } else if (subTime < HOURS_LIMIT) {
            return Math.round(subTime / MINUTES_LIMIT) + " " + "minutes ago";
        } else if (subTime < DAYS_LIMIT) {
            return Math.round(subTime / HOURS_LIMIT) + " " + "days ago";
        } else
            return getDate(date);
    }
    ...
    public static Date StringToDate(String date, String parttern) {
        ...
        if (date != null) {
            try {
                ...
                System.out.println("parttern:" + parttern);
    ...
    public static long DateToLong(Date date) {
        return date.getTime(); // Date类型的getTime()返回毫秒数
    }
